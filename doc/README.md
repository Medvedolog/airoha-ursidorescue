...
Версия: **0.2.0-test17** · статус: simulation candidate / HW PARTIAL (см. [../STATUS.md](../STATUS.md))
...
| [UI_SPEC_RU.md](UI_SPEC_RU.md) | **ТЗ v3.1 на единый интерфейс** Web-GUI / TUI / CLI — утверждённая основа разработки |
...
| [UI_SPEC_RU.md](UI_SPEC_RU.md) | Unified UI specification v3.1 (Web-GUI / TUI / CLI), Russian — the approved development baseline |
