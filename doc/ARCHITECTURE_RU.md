...
[English version](ARCHITECTURE_EN.md) · [Оглавление](README.md) · версия 0.2.0-test13
...
- **Главный пакет:** CRC16 XMODEM, распознавание приглашения, bad-блоки и «хорошие» участки,
  ...
  при неверной CRC, разбор ответов XMODEM (шум, одиночный `CAN`, `CAN CAN`), классификатор EOT
